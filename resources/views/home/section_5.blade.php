    ...
    <div class="container">
        <div class="row align-items-center" id="counter">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="counter-box text-center px-4 py-5 mb-4 mb-lg-0">
                    <div class="text-white">
                        <img src="http://template-lbw.kactusidea.com/neloz/t/HTML/images/icon/icon-1.png" alt="" class="img-fluid mx-auto d-blok">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="counter-box text-center px-4 py-5 mb-4 mb-lg-0">
                    <div class="text-white">
                        <img src="http://template-lbw.kactusidea.com/neloz/t/HTML/images/icon/icon-2.png" alt="" class="img-fluid mx-auto d-blok">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="counter-box text-center px-4 py-5 mb-4 mb-lg-0">
                    <div class="text-white">
                        <img src="http://template-lbw.kactusidea.com/neloz/t/HTML/images/icon/icon-3.png" alt="" class="img-fluid mx-auto d-blok">
                        <h1 class="mb-2 mt-3"><span class="counter-value mt-4" data-count="450">0</span></h1>
                        <p class="mb-0 text-white-70">Event Terlaksana</p>
                    </div>
                </div>
            </div>
        </div>
